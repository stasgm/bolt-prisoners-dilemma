...
export const strategies: Strategy[] = [
	...
	},
	{
		...
		getChoice: (rounds) => (rounds.length === 0 ? "cooperate" : rounds[rounds.length - 1].opponentChoice),
	},
	{
		id: "grudger",
		name: "Grudger",
		description: "Cooperate until betrayed, then always betray",
		getChoice: (rounds) => (rounds.some((r) => r.opponentChoice === "refuse") ? "refuse" : "cooperate"),
	},
	{
		id: "pavlov",
		name: "Pavlov",
